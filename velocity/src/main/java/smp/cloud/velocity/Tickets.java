...
@Plugin(id = "tickets", name = "tickets", version = "1.0", description = "Minecraft plugin for adding the ability to create tickets and solve all your players' problems. The Minecraft plugin is designed for the Velocity proxy system.", url = "https://github.com/cloudy-developers", authors = {"losexds"})
